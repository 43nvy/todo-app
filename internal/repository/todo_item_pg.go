...
func (i *TodoItemPG) Create(listId int, item todo.TodoItem) (int, error) {
	transaction, err := i.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (i *TodoItemPG) GetAll(userId, listId int) ([]todo.TodoItem, error) {
...
func (i *TodoItemPG) GetById(userId, itemId int) (todo.TodoItem, error) {
...
func (i *TodoItemPG) Delete(userId, itemId int) error {
...
func (i *TodoItemPG) Update(userId, itemId int, input todo.UpdateItemInput) error {
